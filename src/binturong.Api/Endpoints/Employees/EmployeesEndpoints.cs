...
public sealed class EmployeesEndpoints : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        ...
        group
            ...
            .RequireScope(SecurityScopes.EmployeesCreate);
        ...
        group
            ...
            .RequireScope(SecurityScopes.EmployeesUpdate);
        ...
        group
            ...
            .RequireScope(SecurityScopes.EmployeesDelete);
        ...
        group
            ...
            .RequireScope(SecurityScopes.EmployeesAttendanceCheckIn);

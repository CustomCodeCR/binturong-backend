...
public sealed class DebitNote : Entity
{
    ...
    public void RaiseCreated() =>
        Raise(new DebitNoteCreatedDomainEvent(Id, InvoiceId, Reason, TotalAmount, IssueDate));

    public void RaiseUpdated() =>
        Raise(
            new DebitNoteUpdatedDomainEvent(
                Id,
                InvoiceId,
                Reason,
                TotalAmount,
    ...
    public void RaiseDeleted() => Raise(new DebitNoteDeletedDomainEvent(Id));
    ...
    public void ActivateContingency(DateTime nowUtc)
    {
        ...
        Raise(new DebitNoteContingencyActivatedDomainEvent(Id, nowUtc));
    }
    ...
    )
    {
        ...
        Raise(new DebitNoteEmittedDomainEvent(Id, taxKey, consecutive, pdfS3Key, xmlS3Key, nowUtc));
    }
}
